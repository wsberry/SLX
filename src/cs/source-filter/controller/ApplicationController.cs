...
namespace source_filter
{
  ...
  public sealed class ApplicationController : IController
  {
    ...
    public Button ButtonRestoreDefaults => (Button)controlsMap_["buttonRestoreDefault"];
    ...
    public CheckBox CheckboxUpdateNamespaces => (CheckBox)controlsMap_["checkBoxUpdateNamespaces"];
    #endregion
    ...
    public void SaveModel()
    {
      ...
      AppDataModel.DirectoryInfo.FindAndReplaceContent = CheckboxUpdateNamespaces.Checked;
    ...
    public void ComposeViews()
    {
      ...
      try
      {
        ...
        ButtonRestoreDefaults.Click += buttonRestoreDefault_Click;
        ...
        CheckboxUpdateNamespaces.CheckedChanged += checkboxUpdateNamespaces_CheckedChanged;
    ...
    private void PostInit()
    {
      ...
      CheckboxUpdateNamespaces.Checked = AppDataModel.DirectoryInfo.FindAndReplaceContent;
    ...
    private void checkboxUpdateNamespaces_CheckedChanged(object sender, EventArgs e)
    {
      // This is a hack for controlling namespacing updates in the
      // CUSTOM codeline.
      //
      CopyFileMethod.UpdateNamespaces = CheckboxUpdateNamespaces.Checked;
    }
    ...
    {
      if (!File.Exists(AppDataModel.GetConfigurationPath())) return;
      File.Delete(AppDataModel.GetConfigurationPath());
      AppDataModel.DirectoryInfo.DirectoryNameFilters.Clear();
      AppDataModel.DirectoryInfo.FileExtensionNameFilters.Clear();
      AppDataModel.DirectoryInfo.FileNameFilters.Clear();
      LoadModel();
      PostInit();
    }
    #endregion
