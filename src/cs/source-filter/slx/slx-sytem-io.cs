...
#if VISUAL_STUDIO_2017_OR_GREATER
       var findHandle = windows_api.native.FindFirstFile(path, out var findData);
#else
       windows_api.native.WIN32_FIND_DATA findData = new windows_api.native.WIN32_FIND_DATA();
       var findHandle = windows_api.native.FindFirstFile(path, out findData);
#endif
